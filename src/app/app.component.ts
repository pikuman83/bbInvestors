...
// import * as ZadarmaCallmeWidget from '../assets/llamanos/full-version/widget.js'
// ZadarmaCallmeWidget = require('../assets/llamanos/full-version/widget.js');
...
export class AppComponent implements OnInit{
  ...
  constructor(public service: GlobalService, @Inject(DOCUMENT) private _document: Document, private _renderer2: Renderer2,
    ...
    public auth: AuthService
      ...
      // var ZadarmaCallmeWidget: any = require('../assets/llamanos/full-version/widget.js');;
      // console.log(ZadarmaCallmeWidget)
    }
    ...
    script.text = `
        {
          ...
          var myZadarmaCallmeWidgetFn10387 = function() {
            ...
            myZadarmaCallmeWidget10387.create({
        "widgetId": "rNnfyspG7tuAf4824urn9vasFU8pzh7DdDe5ZfvgMcL2kCxH8xL5rAbP9Z5u2pGDmb8Rru8hz4Mhjs3u54aSNeykFm12ufZ2cb14c74454d4170824956ddfa828ffbf", "sipId":"267956", "domElement":"myZadarmaCallmeWidget10387" }, { "shape":"square", "language":"es", "width":"0", "dtmf":false, "font": "'Trebuchet MS','Helvetica CY',sans-serif", "color_call": "rgb(255, 255, 255)", "color_bg_call": "rgb(126, 211, 33)", "color_border_call": "rgb(191, 233, 144)", "color_connection": "rgb(255, 255, 255)", "color_bg_connection": "rgb(33, 211, 166)", "color_border_connection": "rgb(144, 233, 211)", "color_calling": "rgb(255, 255, 255)", "color_border_calling": "rgb(255, 218, 128)", "color_bg_calling": "rgb(255, 181, 0)", "color_ended": "rgb(255, 255, 255)", "color_bg_ended": "rgb(164,164,164)", "color_border_ended": "rgb(210, 210, 210)"
            });
          }
  ...
  //   let myZadarmaCallmeWidget10387;
  //   myZadarmaCallmeWidget10387 = new ZadarmaCallmeWidget.ZadarmaCallmeWidget("myZadarmaCallmeWidget10387");
